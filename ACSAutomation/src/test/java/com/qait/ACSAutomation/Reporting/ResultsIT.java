...
public class ResultsIT {
	...
	public String setBodyText() throws IOException {
		...
		mailtext = mailtext + "<br><b><font color = green>Test Case Executed By: </font></b>" + "QAIT Automation Team";
		...
		mailtext = mailtext + "<br>If you have any queries mail to <a href=mailto:prashantshukla@qainfotech.com?Subject=Reply of Automation Status>Prashant Shukla</a></br>";
		return mailtext;
	}
